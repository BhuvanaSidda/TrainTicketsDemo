...
public class TicketServiceImpl implements TicketService {
	...
	private TicketDetails saveTicketDetails(TicketReqDto req) {
		...
		/*
		 * ticketDetails.setTrainNo(req.getTrainNo());
		 * ticketDetails.setSource(req.getSource());
		 * ticketDetails.setDestination(req.getDestination());
		 * ticketDetails.setNoOfPassengers(req.getNoOfPassengers());
		 * ticketDetails.setUserName(req.getUserName());
		 */
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
		LocalDateTime dateTime = LocalDateTime.parse(req.getDepartureDate(), formatter);
